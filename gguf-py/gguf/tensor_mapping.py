...
class TensorNameMap:
    ...
    block_mappings_cfg: dict[MODEL_TENSOR, tuple[str, ...]] = {
        ...
        MODEL_TENSOR.FFN_GATE_INP: (
            ...
            "model.layers.{bid}.mlp.gate.gate",                 # cmoe (gate.gate.weight -> router.gate)
            "model.layers.{bid}.mlp.gate.gate.weight",           # cmoe (with .weight suffix)
        ...
        MODEL_TENSOR.FFN_EXP_PROBS_B: (
            ...
            "model.layers.{bid}.mlp.gate.extra_scale",                      # cmoe
